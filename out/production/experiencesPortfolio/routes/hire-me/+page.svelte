        ...
        <div class="container">
            ...
            <form class="border rounded border-0 shadow-lg p-3 p-md-5" data-bs-theme="light">
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col-md-6">
                            <label class="form-label" for="hire-date">Date</label>
                            <input class="form-control" id="hire-date" type="date" />
                        </div>
                        <div class="col-md-6 button">
                            <button class="btn btn-primary d-block w-100" type="submit">Hire Me</button>
                        </div>
                    </div>
                </div>
            </form>
...
<!-- JS (puedes cargar estos scripts también en layout.svelte si son globales) -->
